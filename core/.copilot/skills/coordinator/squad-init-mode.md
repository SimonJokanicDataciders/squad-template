...
> Load this when user asks to initialize a team, hire agents, or run squad init.
...
3. **Cast the team.** Before proposing names, run the Casting & Persistent Naming algorithm (see squad-casting.md):
